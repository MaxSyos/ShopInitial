const fa: { [key: string]: string } = {
  ...
  createNewCarousel: "افزودن تصویر به اسلایدشو",
  createNewOffer: "ایجاد پیشنهاد جدید",
  editBanner: "ویرایش بنر",
  editCarousel: "ویرایش تصویر",
  editOffer: "ویرایش پیشنهاد",
  existingBanners: "بنرهای موجود",
  existingCarouselImages: "تصاویر اسلایدشو",
  existingOffers: "پیشنهادات موجود",
  existingBrands: "برندهای موجود",
  bannerTitle: "عنوان بنر",
  bannerDescription: "توضیح بنر",
  bannerImage: "تصویر بنر",
  buttonText: "متن دکمه",
  linkUrl: "آدرس لینک",
  isActive: "فعال",
  carouselTitle: "عنوان تصویر",
  carouselDescription: "توضیح تصویر",
  carouselImage: "تصویر اسلایدشو",
  productId: "شناسه محصول",
  discount: "تخفیف (%)",
  startDate: "تاریخ شروع",
  endDate: "تاریخ پایان",
  noBannersFound: "هیچ بنری پیدا نشد",
  noCarouselImagesFound: "هیچ تصویری پیدا نشد",
  noOffersFound: "هیچ پیشنهادی پیدا نشد",
  noBrandsFound: "هیچ برندی پیدا نشد",
  selectFile: "انتخاب فایل",
  uploading: "در حال آپلود...",
  imageUploadSuccess: "تصویر با موفقیت آپلود شد!",
  imageUploadError: "خرابی در آپلود تصویر",
  invalidImageType: "نوع تصویر نامعتبر",
  imageTooLarge: "تصویر بسیار بزرگ است",
  update: "به‌روز‌رسانی",
  cancel: "انصراف",
  saving: "در حال ذخیره...",
